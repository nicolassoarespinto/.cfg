...
vim.keymap.set('v', '<F8>', '<Plug>SlimeRegionSend<CR>gv<ESC>', { desc = 'Send current selection' },
  { noremap = true, silent = true })


vim.keymap.set('n', '<leader>ji', '<Plug>SlimeParagraphSend}', { desc = 'Send current line' },
  { noremap = true, silent = true })
